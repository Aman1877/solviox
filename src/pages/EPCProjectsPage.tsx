...
import { Award, Building, CheckCircle, Mail, Phone, Target, Users } from 'lucide-react';
...
const EPCProjectsPage: React.FC = () => {
  ...
  const services = [
    {
      ...
      description: 'Comprehensive system design, load analysis, and technical specifications tailored to your requirements.'
    },
    {
      icon: <Users size={32} />,
      title: 'Procurement',
      description: 'Sourcing high-quality components from certified manufacturers with competitive pricing and warranties.'
    },
    {
      icon: <Award size={32} />,
      title: 'Construction',
      description: 'Professional installation with certified technicians following international safety and quality standards.'
    },
    {
      icon: <Target size={32} />,
      title: 'Commissioning',
      description: 'Complete system testing, performance verification, and handover with comprehensive documentation.'
    }
  ];
  ...
  const processSteps = [
    { step: '01', title: 'Site Assessment', description: 'Detailed site survey and feasibility analysis' },
    { step: '02', title: 'System Design', description: 'Custom engineering design and technical specifications' },
    { step: '03', title: 'Approvals', description: 'Government permits and regulatory compliance' },
    { step: '04', title: 'Procurement', description: 'Component sourcing and quality verification' },
    { step: '05', title: 'Installation', description: 'Professional construction and system integration' },
    { step: '06', title: 'Commissioning', description: 'Testing, verification, and project handover' }
  ];
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <h1 className="text-5xl md:text-6xl font-bold mb-6 text-white leading-tight">
                Solar & AC
                <span className="block text-secondary-300">EPC Projects</span>
              </h1>
              
              <p className="text-xl mb-8 text-white opacity-90 leading-relaxed max-w-lg">
                End-to-end Engineering, Procurement, and Construction services for large-scale solar installations. From concept to commissioning.
              </p>
              ...
              <div className="grid grid-cols-3 gap-6">
                <div className="text-center">
                  ...
                  <div className="text-sm text-white opacity-70">Installed Capacity</div>
                </div>
                <div className="text-center">
                  <div className="text-2xl font-bold text-white">50+</div>
                  <div className="text-sm text-white opacity-70">Projects Completed</div>
                </div>
                <div className="text-center">
        ...
        <div className="container-custom">
          ...
          >
            ...
            <p className="text-xl max-w-3xl mx-auto" style={{ color: 'var(--text-secondary)' }}>
              Comprehensive Engineering, Procurement, and Construction services for your solar projects.
            </p>
          </motion.div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {services.map((service, index) => (
              ...
              >
                ...
                <h3 className="text-lg font-bold mb-3" style={{ color: 'var(--text-primary)' }}>{service.title}</h3>
      ...
      <section className="section-padding">
        <div className="container-custom">
          ...
          >
            ...
            <p className="text-xl max-w-3xl mx-auto" style={{ color: 'var(--text-secondary)' }}>
              A systematic approach to deliver successful solar projects on time and within budget.
            </p>
          </motion.div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {processSteps.map((process, index) => (
              <motion.div
                ...
                className="relative"
              >
                <div className="rounded-xl p-6 card-shadow hover:shadow-lg transition-shadow" style={{ backgroundColor: 'var(--surface-primary)' }}>
                  <div
                  ...
                  <h3 className="text-xl font-bold mb-3" style={{ color: 'var(--text-primary)' }}>{process.title}</h3>
                  <p className="leading-relaxed" style={{ color: 'var(--text-secondary)' }}>{process.description}</p>
                </div>
      ...
      <section className="section-padding transition-colors duration-300" style={{ backgroundColor: 'var(--bg-primary)' }}>
        <div className="container-custom">
          ...
          >
            ...
            <p className="text-xl max-w-3xl mx-auto" style={{ color: 'var(--text-secondary)' }}>
              From small commercial installations to large utility-scale projects.
            </p>
          </motion.div>
        ...
        <div className="container-custom text-center">
          ...
          >
            ...
            <p className="text-xl mb-8 text-white opacity-90 max-w-2xl mx-auto leading-relaxed">
              Get a comprehensive project proposal and quote for your solar EPC requirements. 
              Our experts will handle everything from design to commissioning.
            </p>
