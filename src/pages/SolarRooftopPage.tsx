  ...
  const benefits = [
    {
      ...
      description:
        "Save up to 90% on your monthly electricity costs with our efficient solar rooftop systems.",
    },
    {
      icon: <Leaf size={32} />,
      title: "Eco-Friendly Energy",
      description:
        "Generate clean, renewable energy and reduce your carbon footprint significantly.",
    },
    {
      icon: <Home size={32} />,
      title: "Increase Property Value",
      description:
        "Solar installations can increase your property value by 15-20% on average.",
    },
    {
      icon: <Zap size={32} />,
      title: "Government Incentives",
      description:
        "Take advantage of government subsidies and tax benefits for solar installations.",
    },
  ];
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <p className="text-xl mb-8 text-white opacity-90 leading-relaxed max-w-lg">
                Transform your rooftop into a clean energy powerhouse. Reduce
                electricity bills by up to 90% while contributing to a
                sustainable future.
              </p>
      ...
      <section className="section-padding">
        <div className="container-custom">
          ...
          >
            ...
            >
              Our solar rooftop systems come with everything you need for a
              complete renewable energy solution.
            </p>
          </motion.div>
        ...
        <div className="container-custom">
          ...
          >
            ...
            <p
              ...
              style={{ color: "var(--text-secondary)" }}
            >
              Discover the advantages of switching to solar energy for your home
              or business.
            </p>
          </motion.div>
        ...
        <div className="container-custom">
          ...
          >
            ...
            <p
              ...
              style={{ color: "var(--text-secondary)" }}
            >
              Our solar rooftop solutions are perfect for various applications
              and building types.
            </p>
          </motion.div>
        ...
        <div className="container-custom text-center">
          ...
          >
            ...
            <p className="text-xl mb-8 text-white opacity-90 max-w-2xl mx-auto leading-relaxed">
              Get a free consultation and customized quote for your solar
              rooftop installation. Our experts will help you choose the perfect
