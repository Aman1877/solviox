  ...
  const benefits = [
    {
      ...
      description:
        "Advanced LED technology provides superior illumination while consuming minimal energy from solar panels.",
    },
    {
      icon: <Clock size={32} />,
      title: "Auto Operation",
      description:
        "Intelligent sensors automatically turn lights on at dusk and off at dawn, ensuring optimal energy usage.",
    },
    {
      icon: <Shield size={32} />,
      title: "Weather Resistant",
      description:
        "IP65 rated protection against dust, rain, and extreme weather conditions for reliable year-round operation.",
    },
    {
      icon: <Zap size={32} />,
      title: "Smart Controls",
      description:
        "Remote monitoring and control features allow for easy management and performance optimization.",
    },
  ];
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <h1 className="text-5xl md:text-6xl font-bold mb-6 text-white leading-tight">
                Solar LED{" "}
                <span className="text-secondary-300">Street Lights</span>
              </h1>

              <p className="text-xl mb-8 text-white opacity-90 leading-relaxed max-w-lg">
                Illuminate streets, pathways, and public spaces with our
                energy-efficient solar LED street lighting solutions. Zero
                electricity costs with maximum brightness.
              </p>
              ...
              >
                ...
                <div className="space-y-4">
                  {features.slice(0, 4).map((feature, index) => (
                    ...
                    >
                      <div className="w-6 h-6 rounded-full bg-white bg-opacity-20 flex items-center justify-center shrink-0">
      ...
      >
        <div className="container-custom">
          ...
          >
            ...
            >
              Discover the advantages of our intelligent solar LED street
              lighting solutions.
            </p>
          </motion.div>
        ...
        <div className="container-custom">
          ...
          >
            ...
            <p
              ...
              style={{ color: "var(--text-secondary)" }}
            >
              Our solar LED street lights are ideal for multiple lighting
              scenarios.
            </p>
          </motion.div>
        ...
        <div className="container-custom text-center">
          ...
          >
            ...
            <p className="text-xl mb-8 text-white opacity-90 max-w-2xl mx-auto leading-relaxed">
              Get a free consultation and customized quote for your solar LED
              street lighting project. Our experts will design the perfect
